...
Vector_element* ElementSum(Vector_element element1, Vector_element element2, data_type* ans_type);
Vector_element* ElementMult(Vector_element element1, Vector_element element2, data_type* ans_type);
